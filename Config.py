...
BOT_TOKEN = os.environ.get("6094064768:AAGOS7E1X3haxG7VZBfkP_LCzACceli9kOs")
API_ID = int(os.environ.get("15179868", "0"))  # Default to 0 if environment variable is not set
API_HASH = os.environ.get("5eed1d89e639551bd74d736037ebd4f9")
